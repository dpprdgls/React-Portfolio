    ...
    <div className='flex-grow items-center justify-center flex-col pt-6 pb-10'>
      <div className='flex flex-col md:flex-row items-center md:items-start'>
        ...
        <div className='text-center md:text-left'>
          <p className='text-orange-400'>Let me tell you a little bit about</p>
          <h1 className='text-4xl md:text-7xl mb-1 md:mb-3 font-bold text-gray-500'>myself</h1>
          <h2 className='text-base md:text-xl mb-3 font-medium text-gray-400'>and how I got here.</h2>
          <p className='text-sm max-w-xl mb-6 font-light sm:text-left'>
